...
3. Discuss if you can prove that this loop terminates for any positive value of n below this question.
   * According to the Collatz conjecture the loop will terminate with any positive n value. It is an unsolvable problem and it claims that no matter what positive integer is entered the sequence will always reach 1. 
