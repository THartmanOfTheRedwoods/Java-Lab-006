...
4 <br>
2 <br>
4. Discuss if you can prove that this loop terminates for any positive value of n below this question. <br>
The loop terminates at 1 since the condition for the loop is for "i" to be greater than 1.
